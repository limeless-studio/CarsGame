...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Plugins/EditorOnly/SimpleFolderIcon/Editor/Resources/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Plugins/EditorOnly/SimpleFolderIcon/Editor/Resources/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Plugins/EditorOnly/SimpleFolderIcon/Editor/Resources/Icons/{f.Name}", typeof(FolderIconSO));
